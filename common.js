...
function changeAction(type) {
    if(type != "register" && document.loginForm.universe.value == '') {
        ...
        if(type == "login") {
            var url = "http://ogame.gameofthronesgame.org/game/reg/login2.php";
            document.loginForm.action = url;
        }
        else if (type=="getpw") {
            //var url = "http://" + document.loginForm.universe.value + "/game/reg/mail.php";
            var url = "http://ogame.gameofthronesgame.org/game/reg/mail.php";
            document.loginForm.action = url;
            document.loginForm.submit();
        }
        else if(type == "register") {
            //var url = "http://" + document.registerForm.universe.value + "/game/reg/newredirect.php";
            var url = "http://ogame.gameofthronesgame.org/game/reg/newredirect.php";
